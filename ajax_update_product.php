<?php 
    ...
    $sql1 = "INSERT INTO `product_stock_inventory` (`stock_inventory_id`, `product_id`, `product_name`, `prior_stock`, `added_stock`, `new_stock`, `date_updated`) VALUES (NULL,'$editID' ,'$nameupdate', '$stockupdate',  '$newstock','$addedstock','$date')";
